...
/**
 * Class AbstractDatabaseOptions is used for options fetch from database with a Database result or model collection.
 *
...
abstract class AbstractDatabaseOptions
{
     ...
     * Construct.
     *
     * @param Result|Collection $collection  Model collection.
