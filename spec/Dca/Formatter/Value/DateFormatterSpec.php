...
class DateFormatterSpec extends ObjectBehavior
{
    ...
    public function it_accepts_tstamp_field()
    {
        $this->accepts('tstamp', [])->shouldReturn(true);
    }

    public function it_accepts_date_rgxp()
    {
        $this->acceptsFormat('date');
    }

    public function it_accepts_datim_rgxp()
    {
        $this->acceptsFormat('datim');
    }

    public function it_accepts_time_rgxp()
    {
        $this->acceptsFormat('time');
    }

    public function it_does_not_accepts_non_date_rgxp()
    {
    ...
    public function it_formats_date_considering_config()
    {
        $this->formatsByConfigFormat('date');
    }

    public function it_formats_datim_considering_config()
    {
        $this->formatsByConfigFormat('datim');
    }

    public function it_formats_time_considering_config()
    {
