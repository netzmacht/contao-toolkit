...
class TranslatorPassSpec extends ObjectBehavior
{
    ...
    function it_creates_translator_definition_if_contao_translator_does_not_exists(ContainerBuilder $container)
    {
    ...
    function it_does_not_process_if_contao_translator_exists(ContainerBuilder $container)
    {
