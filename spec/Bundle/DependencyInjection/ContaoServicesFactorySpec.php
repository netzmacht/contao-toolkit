...
{
    public function let(ContaoFrameworkInterface $framework)
    {
    ...
    public function it_creates_frontend_user_instance(ContaoFrameworkInterface $framework, FrontendUser $frontendUser)
    {
    ...
    public function expectAdapterWillBeReturned(ContaoFrameworkInterface $framework, $class, Adapter $adapter)
    {
        $framework->initialize()->shouldBeCalled();
        $framework->getAdapter($class)->willReturn($adapter)->shouldBeCalled();
    }

    public function expectInstanceWillBeCreated(ContaoFrameworkInterface $framework, $class, $instance)
    {
        $framework->initialize()->shouldBeCalled();
